...
import { deleteAnnouncement } from '@/app/lib/actions';
...
export function CreateAnnouncements() {
  return (
    ...
    >
      <span className="hidden md:block">Create Announcements</span>{' '}
      <PlusIcon className="h-5 md:ml-4" />
    </Link>
  );
}

export function UpdateAnnouncements({ id }: { id: number }) {
  return (
    <Link
...
export function DeleteAnnouncements({ id }: { id: number }) {
